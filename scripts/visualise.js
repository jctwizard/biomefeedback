...
function viewSurveyResults(surveyIndex)
{
  ...
  var visualiseButton = makeElement(editorPanel, "button", "visualise", "visualiseButton", surveyIndex.toString());
  visualiseButton.setAttribute("onclick", "visualiseSurveyResults(" + surveyIndex.toString() + ")");
